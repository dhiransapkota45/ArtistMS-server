...
export class ArtistController {
    ...
    async getAllArtist (req: Request, res: Response): Promise<any> {
        ...
        return ApiResponse.success(res, "Artists retrieved successfully", artist, 200);
    }
    ...
    async getArtist (req: Request, res: Response): Promise<any> {
        ...
        return ApiResponse.success(res, "Artist retrieved successfully", artist, 200);
    }
    ...
    async updateArtist (req: Request, res: Response): Promise<any> {
        ...
        const artist = await this.artistService.updateArtistById(Number(req.params.id), req.body);
    ...
    async deleteArtist (req: Request, res: Response): Promise<any> {
        ...
        const artist = await this.artistService.deleteArtistById(Number(req.params.id));
